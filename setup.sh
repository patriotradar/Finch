...
echo "========================================="
echo ""
echo "To install voice support (optional, requires GPU for voice cloning):"
echo "  source venv/bin/activate"
echo "  pip install openai-whisper TTS pyaudio SpeechRecognition"
echo ""
echo "To start Finch:"
echo "  source venv/bin/activate"
echo "  python main.py"
...
echo ""
echo "For voice cloning (Finch's voice):"
echo "  Place a clean Michael Emerson audio clip at ./data/audio/finch_reference.wav"
echo "  30+ seconds, 22050Hz, 16-bit mono WAV"
echo ""
...
echo "  export SHODAN_API_KEY='your-shodan-key'  # optional"
echo ""
echo "— Finch"
